...
2. **Accept at-least-once delivery.** Document that mid-batch reconnects produce duplicates. Clients must deduplicate. Lowest effort but weakens SSE's correctness guarantee.
